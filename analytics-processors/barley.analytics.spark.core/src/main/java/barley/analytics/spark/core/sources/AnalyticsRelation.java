...
package barley.analytics.spark.core.sources;

import static barley.analytics.spark.core.util.AnalyticsCommonUtils.isEmptyAnalyticsSchema;
import static barley.analytics.spark.core.util.AnalyticsCommonUtils.isEmptySchema;
...
import barley.analytics.spark.core.rdd.AnalyticsRDD;
import barley.analytics.spark.core.util.AnalyticsConstants;
import barley.analytics.spark.core.util.AnalyticsConstants.IncrementalWindowUnit;
import barley.analytics.spark.core.util.IncrementalUtils;
