...
* under the License.
*/
package barley.analytics.eventsink;
...
import barley.analytics.eventsink.exception.AnalyticsEventStoreDeploymentException;
import barley.analytics.eventsink.exception.AnalyticsEventStoreException;
import barley.analytics.eventsink.internal.AnalyticsEventSinkServerStartupObserver;
import barley.analytics.eventsink.internal.AnalyticsEventStoreManager;
...
public class AnalyticsEventStoreDeployer extends AbstractDeployer {
    ...
    public void init(ConfigurationContext configurationContext) {
        File deployementDir = new File(MultitenantUtils.getAxis2RepositoryPath(BarleyContext.getThreadLocalCarbonContext().
    ...
    public void deploy(DeploymentFileData deploymentFileData) throws DeploymentException {
    	// (주석) 2019.08.06 - 수동으로 파일을 등록하도록 변경 
