...
import barley.analytics.dataservice.core.tasks.AnalyticsDataPurgingTask;
...
public class AnalyticsDataPurgingDeployer implements AppDeploymentHandler {
    ...
    private TaskInfo createDataPurgingTask(String table, String cronString, int retentionPeriod) {
        ...
        taskProperties.put(Constants.TENANT_ID, String.valueOf(BarleyContext.getThreadLocalCarbonContext().getTenantId()));
    ...
    private String getDataPurgingTaskName(String table) {
        return PrivilegedBarleyContext.getThreadLocalCarbonContext().getTenantDomain() + "_" + table + "_" + "data_purging_task";
    }
}
