...
import barley.analytics.dataservice.commons.exception.AnalyticsInterruptException;
...
import barley.analytics.dataservice.core.indexing.AnalyticsIndexedTableStore.IndexedTableId;
import barley.analytics.dataservice.core.indexing.LocalShardAllocationConfig.ShardStatus;
import barley.analytics.dataservice.core.indexing.StagingIndexDataStore.StagingIndexDataEntry;
        ...
        if (this.stagingWorkerExecutor != null) {
            ...
            try {
                this.stagingWorkerExecutor.awaitTermination(
                        barley.analytics.dataservice.core.Constants.INDEX_WORKER_STOP_WAIT_TIME, TimeUnit.MILLISECONDS);
